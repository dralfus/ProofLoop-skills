...
class ValidatePluginTest(unittest.TestCase):
    ...
    def test_selects_codex_profile_from_arbitrary_verified_inventory(self) -> None:
        ...
        self.assertEqual(
            result.stdout,
            '{"budget": {"critical": {"compaction": 1, "frontier": 1, "full_suite": 1, "role_agents": 4}, "ordinary": {"compaction": 0, "frontier": 0, "full_suite": 1, "role_agents": 3}}, "models": {"controller": {"degradation_reason": null, "degraded": false, "effort": "medium", "id": "small-current", "requested_tier": "efficient", "selected_tier": "efficient"}, "implementer": {"degradation_reason": null, "degraded": false, "effort": "high", "id": "small-current", "requested_tier": "efficient", "selected_tier": "efficient"}, "reviewer": {"degradation_reason": null, "degraded": false, "effort": "medium", "id": "balanced-current", "requested_tier": "standard", "selected_tier": "standard"}, "verifier": {"degradation_reason": null, "degraded": false, "effort": "medium", "id": "small-current", "requested_tier": "efficient", "selected_tier": "efficient"}}, "status": "CODEX_PROFILE"}\n',
        )
